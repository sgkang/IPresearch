...
% induced polarization, inductive source, electromagnetic, time domain

% Key words:
% Electrical properties, Geomagnetic induction, CSEM, Numerical approximations and analyses, Inverse theory

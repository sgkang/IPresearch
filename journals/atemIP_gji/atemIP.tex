...
\begin{figure}
  % \centering
  \figbox{6cm}{5cm}{figures/FDandTDCole.png}
...
\bibitem[\protect\citename{Chen }2003]{Chen2003}
Jiuping Chen and Douglas {W. Oldenburg}.
\newblock {3-D inversion of magnetic induced polarization data}.
\newblock {\em ASEG Extended Abstracts}, 2003(1):1--11, January 2003.

\bibitem[\protect\citename{1}]{COLE}
Kenneth~S. Cole and Robert~H. Cole.
\newblock Dispersion and absorption in dielectrics i. alternating current
  characteristics.
\newblock {\em The Journal of Chemical Physics}, 9(4), 1941.

\bibitem[\protect\citename{1}]{ElKaliouby2004}
H~El‐Kaliouby and E~Eldiwany.
\newblock {Transient electromagnetic responses of 3D polarizable body}.
\newblock {\em GEOPHYSICS}, 69(2):426--430, 2004.

\bibitem[\protect\citename{1}]{Fink1990}
J~Fink, E~McAlister, B~Sternberg, W~Wieduwilt, and S~Ward.
\newblock {\em {Induced Polarization Applications and Case Histories}}.
\newblock Society of Exploration Geophysicists, 1990.

\bibitem[\protect\citename{1}]{Flis1989}
Marcus~F. Flis, Gregory~A. Newman, and Gerald~W. Hohmann.
\newblock Induced‐polarization effects in time‐domain electromagnetic
  measurements.
\newblock {\em GEOPHYSICS}, 54(4):514--523, 1989.

\bibitem[\protect\citename{1}]{Eldadbook}
E~Haber.
\newblock {\em {Computational Methods in Geophysical Electromagnetics}}.
\newblock Society for Industrial and Applied Mathematics, Philadelphia, PA,
  2014.

\bibitem[\protect\citename{1}]{Hordt2006}
Andreas H\"{o}rdt, Tilman Hanstein, Mark H\"{o}nig, and Fritz~Manfred Neubauer.
\newblock {Efficient spectral IP-modelling in the time domain}.
\newblock {\em Journal of Applied Geophysics}, 59(2):152--161, June 2006.

\bibitem[\protect\citename{1}]{Kang2014}
Seogi Kang, Kyubo Noh, Soon~Jee Seol, and Joongmoo Byun.
\newblock {mCSEM inversion for CO2 sequestration monitoring at a deep brine
  aquifer in a shallow sea}, 2014.

\bibitem[\protect\citename{1}]{Kang2015a}
Seogi Kang and Douglas {W. Oldenburg}.
\newblock {Recovering IP information in airborne-time domain electromagnetic
  data}.
\newblock {\em ASEG Extended Abstracts}, 2015(1):1--4, January 2015.

\bibitem[\protect\citename{1}]{Kang2015b}
Seogi Kang, Douglas {W. Oldenburg}, and Michael {S. McMillan}.
\newblock {3D IP Inversion of Airborne EM data at Tli Kwi Cho}.
\newblock {\em ASEG Extended Abstracts}, 2015(1):1--4, January 2015.

\bibitem[\protect\citename{1}]{Kelley}
C.~T. Kelley.
\newblock {\em Iterative Methods for Optimization}.
\newblock Society for Industrial and Applied Mathematics, 1999.

\bibitem[\protect\citename{1}]{Kemna2012}
...
\newblock {An overview of the spectral induced polarization method for
  near-surface applications}.
\newblock {\em Near Surface Geophysics}, 10(6):453--468, 2012.

\bibitem[\protect\citename{1}]{Kohlrausch1854}
R~Kohlrausch.
\newblock {Theorie des elektrischen R\"{u}ckstandes in der Leidener Flasche}.
\newblock {\em Annalen der Physik}, 167(2):179--214, 1854.

\bibitem[\protect\citename{1}]{Kratzer2012}
T~Kratzer and J~Macnae.
\newblock {Induced polarization in airborne EM}.
\newblock {\em Geophysics}, 77(5):E317--E327, 2012.

\bibitem[\protect\citename{1}]{LiMag3D}
Yaoguo Li and Douglas~W. Oldenburg.
\newblock 3-d inversion of magnetic data.
\newblock {\em GEOPHYSICS}, 61(2):394--408, 1996.

\bibitem[\protect\citename{1}]{Li2000}
Yaoguo Li and Douglas~W. Oldenburg.
\newblock {3-D inversion of induced polarization data}.
\newblock {\em Geophysics}, 65(6):1931--1945, November 2000.

\bibitem[\protect\citename{1}]{Marchant2012b}
D.~Marchant, E.~Haber, and D.~W. Oldenburg.
\newblock {Inductive source induced polarization}.
\newblock {\em Geophysical Journal International}, 192(2):602--612, November
  2012.

\bibitem[\protect\citename{1}]{Marchant2014}
David Marchant, Eldad Haber, and Douglas~W. Oldenburg.
\newblock Three-dimensional modeling of ip effects in time-domain
  electromagnetic data.
\newblock {\em GEOPHYSICS}, 79(6):E303--E314, 2014.

\bibitem[\protect\citename{1}]{doug1994}
D.~Oldenburg and Y.~Li.
\newblock Inversion of induced polarization data.
\newblock {\em GEOPHYSICS}, 59(9):1327--1341, 1994.

\bibitem[\protect\citename{1}]{Doug2015}
Douglas~W Oldenburg, Seogi Kang, and David Marchant.
\newblock {\em {Inversion of time domain IP data from inductive sources}},
  chapter~2, pages 9--12.

\bibitem[\protect\citename{1}]{DougTutorial}
Douglas~W Oldenburg and Yaoguo Li.
\newblock {\em {5. Inversion for Applied Geophysics: A Tutorial}}, chapter~5,
  pages 89--150.
\newblock 2005.

\bibitem[\protect\citename{1}]{Pelton1978}
W~Pelton, S~Ward, P~Hallof, W~Sill, and P~Nelson.
\newblock {MINERAL DISCRIMINATION AND REMOVAL OF INDUCTIVE COUPLING WITH
  MULTIFREQUENCY IP}.
\newblock {\em Geophysics}, 43(3):588--609, 1978.

\bibitem[\protect\citename{1}]{routh2001}
...
\newblock {\em Geophysical Journal International}, 145(1):59--76, 2001.

\bibitem[\protect\citename{1}]{seigel1959}
H.~Seigel.
\newblock Mathematical formulation and type curves for induced polarization.
\newblock {\em GEOPHYSICS}, 24(3):547--565, 1959.

\bibitem[\protect\citename{1}]{seigel1974}
H.~Seigel.
\newblock The magnetic induced polarization (mip) method.
\newblock {\em GEOPHYSICS}, 39(3):321--339, 1974.

\bibitem[\protect\citename{1}]{SmithandKlein}
Richard~S. Smith and Jan Klein.
\newblock A special circumstance of airborne induced‐polarization
  measurements.
\newblock {\em GEOPHYSICS}, 61(1):66--73, 1996.

\bibitem[\protect\citename{1}]{Smith1988a}
Richard~S. Smith, PW~Walker, BD~Polzer, and G.~F. West.
\newblock {The time-domain electromagnetic response of polarizable bodies: an
  approximate convolution algorithm}.
\newblock {\em Geophysical Prospecting}, 36(April):772--785, 1988.

\bibitem[\protect\citename{1}]{Weidelt1982}
P~Weidelt.
\newblock {Response characteristics of coincident loop transient
  electromagnetic systems}.
\newblock 47(September):1325--1330, 1982.

\bibitem[\protect\citename{1}]{Yuval1997}
Yuval and D.~Oldenburg.
\newblock Computation of cole‐cole parameters from ip data.
\newblock {\em Geophysics}, 62(2):436--448, 1997.
